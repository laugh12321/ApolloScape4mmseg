...
def apolloscapes_classes():
    """ApolloScapes class names for external use."""
    return [
...
def apolloscapes_palette():
    """ApolloScapes palette for external use."""
    return [[0, 0, 0], [70, 130, 180], [220, 20, 60], [128, 0, 128], [255, 0, 0], [0, 0, 60], [0, 60, 100], [0, 0, 142], [119, 11, 32],
